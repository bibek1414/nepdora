...
import { generateLinkHref as getCentralizedHref } from "@/lib/link-utils";
...
const PageSelector: React.FC<PageSelectorProps> = ({
  ...
  return (
    <Card className="absolute top-full left-0 z-[9999] mt-1 w-80 bg-white py-0 shadow-xl">
...
export const EditableLink: React.FC<EditableLinkProps> = ({
  ...
  const generateLinkHref = (originalHref: string) => {
    return getCentralizedHref(originalHref, siteUser, pathname, isEditable);
  };
