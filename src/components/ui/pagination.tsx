    ...
    `inline-flex items-center justify-center w-10 h-10 text-sm font-medium transition-all duration-200 border rounded-lg ${
      isDisabled
        ...
        : isActive
          ...
          : "text-gray-700 bg-white border-gray-300 hover:bg-gray-50 hover:border-gray-400 hover:text-gray-900"
    }`;
    ...
    <div className="mt-12 flex flex-col items-center gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {!visiblePages.includes(totalPages) && (
          <>
            ...
            <button
              ...
              className={
                buttonClass(currentPage === totalPages) + " cursor-pointer"
              }
            >
              {totalPages}
            </button>
        ...
        <button
          ...
          className={
            navButtonClass(currentPage === totalPages) + " cursor-pointer"
          }
