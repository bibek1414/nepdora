...
export default function RelatedAlternatives({ currentSlug }: RelatedAlternativesProps) {
    ...
    <section className="bg-slate-50 py-20">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-bold text-slate-900">Explore More Alternatives</h2>
          <p className="mt-4 text-slate-600">See how Nepdora compares against other global website builders.</p>
        </div>
          ...
          {otherCompetitors.map((competitor) => (
            ...
            >
              <div>
                ...
                <p className="text-sm text-slate-500">The best local alternative</p>
              </div>
