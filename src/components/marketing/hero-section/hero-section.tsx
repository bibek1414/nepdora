          ...
          <div className="max-w-xl flex-1">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Link
                ...
                className="hover:bg-secondary inline-flex transform items-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-medium text-slate-700 transition-all duration-200 hover:-translate-y-1"
              >
