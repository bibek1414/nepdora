...
import { Layout, TrendingUp, CreditCard, Smartphone, ShieldCheck } from "lucide-react";
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-16 text-center">
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            What makes <span className="text-indigo-600">Nepdora different</span>
          </h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((item, i) => (
            <div 
              key={i} 
              className="group rounded-2xl border border-slate-100 bg-white p-8 transition-all hover:border-indigo-100 hover:shadow-xl hover:shadow-indigo-50/50"
            >
