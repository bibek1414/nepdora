...
export function MissionVisual() {
  ...
  return (
    <div className="relative select-none">
        ...
        <div className="p-6">
          <div className="mb-6 grid grid-cols-2 gap-4">
            <div className="rounded-xl border border-indigo-50 bg-indigo-50/30 p-4">
              <Globe className="mb-2 h-5 w-5 text-indigo-600" />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-700">Digital Empowerment</span>
      ...
      {/* Floating Elements */}
      <div
        className="absolute -top-6 -right-6 flex items-center gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-xl transition-all duration-1000 delay-300"
        style={{
          opacity: mounted ? 1 : 0,
      ...
      >
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400">Nepali owned & operated</p>
        </div>
      </div>

      <div
        className="absolute -bottom-8 -left-8 flex items-center gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-xl transition-all duration-1000 delay-500"
        style={{
          opacity: mounted ? 1 : 0,
          transform: mounted ? "translateY(0)" : "translateY(-20px)",
        }}
      >
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400">Bank-grade infrastructure</p>
        </div>
      </div>
    </div>
  );
