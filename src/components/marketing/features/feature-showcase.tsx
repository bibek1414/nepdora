      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-3 gap-2.5">
          {templates.map(t => (
            <div
              key={t.name}
              className="group cursor-pointer overflow-hidden rounded-lg border border-slate-100 transition-colors hover:border-indigo-300"
            >
              <div className={`${t.color} flex h-16 items-end p-2`}>
      ...
      <div className="space-y-4 p-5">
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <div
              key={p.name}
              className={`cursor-pointer rounded-lg border px-3 py-2 text-center text-xs font-semibold ${p.color}`}
            >
              {p.name}
            </div>
          ))}
      ...
      <div className="space-y-4 p-5">
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={s.label} className="rounded-xl bg-slate-50 p-3">
              <p className="mb-1 text-[10px] text-slate-400">{s.label}</p>
        ...
        <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-3">
          ...
          <p className="mt-0.5 text-[10px] text-emerald-600">
            Meta tags · Schema markup · XML sitemap · Open Graph
          </p>
        </div>
      </div>
    </div>
          ...
          {orders.map(o => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${statusColor[o.status]}`}
                >
                  {o.status}
                </span>
              </div>
        ...
        <div className="space-y-1.5">
          ...
          {[
            ...
            <div key={s.source} className="flex items-center gap-2">
              <span className="w-28 shrink-0 text-[10px] text-slate-600">
                {s.source}
              </span>
    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
      ...
      <div className="space-y-3 p-5">
        ...
        <div className="rounded-xl border border-slate-100 bg-slate-50 p-3">
          ...
          <p className="rounded border border-slate-100 bg-white p-2 font-mono text-[10px] text-slate-500">
