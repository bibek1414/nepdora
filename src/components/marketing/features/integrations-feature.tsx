      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <div>
            ...
            <Link
              href="/integrations"
              className="group hover:-xl hover:-slate-200 inline-flex items-center gap-2 rounded-full bg-slate-900 px-6 py-3 text-sm font-bold text-white transition-all hover:bg-slate-800"
            >
          ...
          <div className="relative">
            <div className="-2xl relative overflow-hidden rounded-2xl border border-slate-200 bg-white">
              ...
              <div className="p-8">
                <div className="grid grid-cols-2 gap-4">
                  {featuredIntegrations.map((app, idx) => (
                    <div
                      ...
                      className={`flex flex-col items-center rounded-xl border border-slate-100 bg-white p-4 transition-all hover:border-sky-200 hover:bg-sky-50/30 ${
                        idx === 0 ? "-md -slate-100 scale-105" : "opacity-80"
                      }`}
                    >
                  ...
                  <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-200 bg-slate-50/50 p-4">
                    <div className="-sm mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-white text-slate-400">
