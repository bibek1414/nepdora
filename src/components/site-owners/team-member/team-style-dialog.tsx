  ...
  const styles = [
    {
      id: "grid-1" as const,
      name: "Grid Style 1",
      description: "Simple grid layout with image overlays.",
      preview: (
        <Image
          src="/images/site-owners/team/team1.png"
          alt="Team grid 1"
          width={120}
          height={120}
        />
    ...
    },
    {
      id: "grid-2" as const,
      name: "Grid Style 2",
      description: "Circular images with centered layout.",
      preview: (
        <Image
          src="/images/site-owners/team/team2.png"
          alt="Team grid 2"
          width={120}
          height={120}
        />
    ...
    },
    {
      id: "list-1" as const,
      name: "List Style",
      description: "Horizontal layout with detailed information.",
      preview: (
        <Image
          src="/images/site-owners/team/team3.png"
          alt="Team list"
          width={120}
          height={120}
        />
