          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-1 gap-4 py-4">
              <button
                ...
                className="border-muted bg-popover hover:bg-accent flex cursor-pointer flex-col items-center justify-between rounded-md border-2 p-4 text-left transition-all duration-200 hover:border-green-600"
              >
