// components/site-owners/admin/plugins/logistics/ydm.tsx
...
function YDMPage() {
  const { data: logistics = [], isLoading, refetch } = useLogisticsYDM();
  ...
  const ydmConfig = logistics.find((l: Logistics) => l.logistic === "YDM");

  useEffect(() => {
    if (ydmConfig) {
      setFormData({
        email: ydmConfig.email || "",
        password: ydmConfig.password || "",
        client_id: ydmConfig.client_id?.toString() || "",
        client_secret: ydmConfig.client_secret || "",
        grant_type: ydmConfig.grant_type || "",
        is_enabled: ydmConfig.is_enabled,
      });
    }
  }, [ydmConfig]);
  ...
  const handleSave = async () => {
    try {
      ...
      if (ydmConfig) {
        ...
        toast.success("YDM configuration updated successfully");
      } else {
        await createMutation.mutateAsync(payload);
        toast.success("YDM configuration created successfully");
      }

      refetch();
    } catch (error) {
      toast.error(
        `Failed to ${ydmConfig ? "update" : "create"} YDM configuration`
      );
    }
  };
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        name="email"
                        type="email"
                        placeholder="Enter YDM account email"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        name="password"
                        type="password"
                        placeholder="Enter YDM password"
