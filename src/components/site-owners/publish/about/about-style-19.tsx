...
export function AboutUsTemplate19({ aboutUsData }: AboutUsTemplate19Props) {
  ...
  const renderTitle = () => {
    const { title, italicWord } = aboutUsData;
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="mb-12 h-fit lg:sticky lg:top-32 lg:mb-0">
            <span className="mb-4 block text-sm font-medium text-blue-600">
              {aboutUsData.sectionTag}
            </span>
          ...
          <div className="relative pl-8 md:pl-12">
            ...
            <div className="space-y-12">
              {aboutUsData.steps.map((step, idx) => {
                const threshold = idx / (aboutUsData.steps.length - 0.5);
