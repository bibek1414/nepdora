    ...
    <section className="relative mx-auto w-full max-w-7xl px-4 py-16 md:py-24">
      <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
        ...
        <div className="relative h-[600px] w-full select-none lg:h-[700px]">
          {/* MAIN IMAGE */}
          <div className="absolute top-0 left-0 z-10 h-[65%] w-[85%] overflow-hidden rounded-2xl shadow-xl">
          ...
          {/* SECONDARY IMAGE */}
          <div className="absolute right-4 bottom-0 z-20 h-[55%] w-[75%] overflow-hidden rounded-xl shadow-2xl">
