...
const MOCK_ORDER = {
  ...
  shipping_address: "123 Sample Street, Kathmandu",
  city: "Kathmandu",
...
const OrderConfirmationStyle1 = ({
  ...
  // If we have no order and we ARE in builder (but MOCK_ORDER somehow failed or isn't used), show nothing but don't error.
...
export default OrderConfirmationStyle1;
