...
interface SubCategoryStylesDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onStyleSelect: (style: "grid-1" | "grid-2" | "list-1") => void;
}

export const SubCategoryStylesDialog: React.FC<
  SubCategoryStylesDialogProps
  ...
  const styles = [
    {
      id: "grid-1" as const,
      name: "Grid Style 1",
      description: "Beautiful grid layout with overlay text for subcategories.",
      preview: (
        <Image
          src="/images/site-owners/subcategories/subcategory1.png"
          alt="SubCategory grid 1"
          width={120}
          height={120}
        />
      ),
    },
    {
      id: "grid-2" as const,
      name: "Grid Style 2",
      description: "Compact horizontal card layout for subcategories.",
      preview: (
        <Image
          src="/images/site-owners/subcategories/subcategory2.png"
          alt="SubCategory grid 2"
          width={120}
          height={120}
        />
      ),
    },
    {
      id: "list-1" as const,
      name: "List Style",
      description: "Detailed list layout for subcategories.",
      preview: (
        <Image
          src="/images/site-owners/subcategories/subcategory3.png"
          alt="SubCategory list"
          width={120}
          height={120}
        />
      ),
      ...
      <DialogContent className="max-h-[90vh] max-w-4xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Choose SubCategory Section Style
          </DialogTitle>
          <DialogDescription>
