...
export const TeamCard8: React.FC<TeamCard8Props> = ({
  ...
  return (
    ...
    >
      {/* Image Container */}
      <div className="group relative mb-5 aspect-[4/3] w-full overflow-hidden rounded-[24px] bg-gray-200">
        <Image
          src={member.photo}
          alt={member.name}
          fill
        ...
        <div className="relative ml-4">
          ...
          >
            {member.twitter && (
              <button
                ...
                className="p-1 text-white transition-colors hover:text-green-100"
                aria-label="Twitter"
              >
          ...
          <button
            className={`flex h-10 w-10 items-center justify-center rounded-full border transition-all duration-300 ${
              isHovered
                ? "rotate-90 border-[#84cc16] bg-[#84cc16] text-white"
                : "border-green-200 bg-white text-[#84cc16] hover:border-[#84cc16]"
            }`}
            aria-label="Share"
          >
