...
export const BannerTemplate7: React.FC<BannerTemplateProps> = ({
  bannerData,
  siteUser,
  isEditable = false,
  onUpdate,
  ...
  const currentBgClass =
    data.bgClass || "bg-gradient-to-br from-slate-900 to-gray-800";
    ...
    <section className="w-full space-y-2 py-8 sm:space-y-4">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div
          ...
          style={{ backgroundColor: !data.bgClass ? "#0f172a" : undefined }} // fallback slate-900
        >
