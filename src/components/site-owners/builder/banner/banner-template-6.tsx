...
export const BannerTemplate6: React.FC<BannerTemplateProps> = ({
  bannerData,
  siteUser,
  isEditable = false,
  onUpdate,
  ...
  const getImageUrl = (image: any) => {
    ...
    return "https://images.unsplash.com/photo-1542393545-10f5cde2c810?q=80&w=765&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
  };

  const currentBgClass =
    data.bgClass || "bg-gradient-to-br from-indigo-950 to-navy-900";
    ...
    <section className="w-full space-y-2 py-8 sm:space-y-4">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div
          ...
          style={{ backgroundColor: !data.bgClass ? "#1e1b4b" : undefined }} // fallback indigo-950
        >
