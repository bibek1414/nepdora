...
import { CategoryCard1 } from "../category-card/category-card-1";
...
export const CategoryStyle1: React.FC<CategoryStyleProps> = ({
  data,
  isEditable = false,
  siteUser,
  onUpdate,
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {categories.map(category => (
              ...
              >
                ...
                <CategoryCard1 category={category} siteUser={siteUser} />
              </div>
            ))}
          </div>
        )}
