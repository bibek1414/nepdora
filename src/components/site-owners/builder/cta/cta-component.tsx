...
import { CTATemplate5 } from "./cta-style-5";
import { CTATemplate6 } from "./cta-style-6";
import { CTATemplate7 } from "./cta-style-7";
import { CTATemplate8 } from "./cta-style-8";
import {
...
export const CTAComponent: React.FC<CTAComponentProps> = ({
  ...
  const renderCTATemplate = () => {
    ...
    if (isCTATemplate5(component.data)) {
      return <CTATemplate5 ctaData={component.data} {...commonProps} />;
    }

    if (isCTATemplate6(component.data)) {
      return <CTATemplate6 ctaData={component.data} {...commonProps} />;
    }

    if (isCTATemplate7(component.data)) {
      return <CTATemplate7 ctaData={component.data} {...commonProps} />;
    }

    if (isCTATemplate8(component.data)) {
      return <CTATemplate8 ctaData={component.data} {...commonProps} />;
    }
