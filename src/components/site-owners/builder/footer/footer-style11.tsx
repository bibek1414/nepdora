      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col space-y-6 lg:col-span-4 lg:pr-12">
            ...
            <p className="max-w-[280px] text-base opacity-80">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="flex flex-col space-y-4">
              ...
              {categories.length === 0 && (
                <li className="text-sm opacity-60">No categories found</li>
              )}
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="flex flex-col space-y-5">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm leading-relaxed whitespace-pre-line opacity-80">
                  {siteConfig?.address ||
                    "2972 Westheimer Rd.\nSanta Ana, Illinois\n85486"}
                </span>
              </li>
...
const FooterLink: React.FC<{
  ...
  return (
    <Link
      ...
      className="w-fit text-sm transition-colors opacity-80 hover:opacity-100 font-medium"
    >
      {children}
    </Link>
  );
