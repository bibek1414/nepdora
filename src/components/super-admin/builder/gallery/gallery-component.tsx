...
import { GalleryTemplate1 } from "@/components/site-owners/builder/gallery/gallery-template-1";
import { GalleryTemplate2 } from "@/components/site-owners/builder/gallery/gallery-template-2";
import { GalleryTemplate3 } from "@/components/site-owners/builder/gallery/gallery-template-3";
import {
...
export const GalleryComponent: React.FC<GalleryComponentProps> = ({
  ...
  const deleteGalleryMutation = useDeleteComponentMutation(
    pageSlug,
    "gallery",
    templateSlug
  );
  const updateGalleryMutation = useUpdateComponentMutation(
    pageSlug,
    "gallery",
    templateSlug
  );
