...
import { AboutUsTemplate3 } from "@/components/site-owners/builder/about/about-style-3";
import { AboutUsTemplate4 } from "@/components/site-owners/builder/about/about-style-4";
import { AboutUsTemplate5 } from "@/components/site-owners/builder/about/about-style-5";
import {
...
export const AboutUsComponent: React.FC<AboutUsComponentProps> = ({
  ...
  const deleteAboutUsMutation = useDeleteComponentMutation(
    pageSlug,
    "about",
    templateSlug
  );
  const updateAboutUsMutation = useUpdateComponentMutation(
    pageSlug,
    "about",
    templateSlug
  );
