...
import { FAQCard1 } from "@/components/site-owners/builder/faq/faq-card-1";
import { FAQCard2 } from "@/components/site-owners/builder/faq/faq-card-2";
import { FAQCard3 } from "@/components/site-owners/builder/faq/faq-card-3";
import { FAQCard4 } from "@/components/site-owners/builder/faq/faq-card-4";
import { FAQCard5 } from "@/components/site-owners/builder/faq/faq-card-5";
...
import { FAQForm } from "@/components/site-owners/admin/faq/faq-form";
...
export const FAQComponent: React.FC<FAQComponentProps> = ({
  ...
  const deleteFAQComponent = useDeleteComponentMutation(
    pageSlug || "",
    "faq",
    templateSlug
  );
  const updateFAQComponent = useUpdateComponentMutation(
    pageSlug || "",
    "faq",
    templateSlug
  );
