...
import { BannerTemplate1 } from "@/components/site-owners/builder/banner/banner-template-1";
import { BannerTemplate2 } from "@/components/site-owners/builder/banner/banner-template-2";
import {
