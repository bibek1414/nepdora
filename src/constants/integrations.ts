    ...
    hardWay: [
      {
        ...
        description:
          "Apply for a merchant account and wait for manual KYC verification.",
      },
      {
        title: "Technical Implementation",
        description:
          "Develop custom backend logic for hash generation and verification.",
      },
      {
        title: "Update API Keys",
        description:
          "Manually handle UAT and Production keys transition and testing.",
      },
    ],
    ...
    hardWay: [
      {
        title: "API Setup",
        description:
          "Configure complex SDKs and handle various payment states.",
      },
      {
        title: "Webhook Handling",
        description:
          "Set up and secure custom webhooks for payment status updates.",
      },
      {
        title: "Security Compliance",
        description:
          "Ensure transaction data is handled securely on your servers.",
      },
    ],
