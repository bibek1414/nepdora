...
const clothingStoreContent: IndustryContent = {
  ...
  description: "The ultimate platform for fashion boutiques and clothing brands in Nepal to sell online effortlessly.",
  benefits: [
  ...
  whyUs: "Nepdora understands the Nepali fashion market. We help you transition from social media selling to a professional, automated online store.",
...
const educationalConsultancyContent: IndustryContent = {
  ...
  description: "Build trust with students and parents using a high-converting website for your consultancy.",
  benefits: [
  ...
  whyUs: "In the competitive education sector, a professional digital presence is everything. Nepdora helps you stand out and win student trust.",
...
const travelAgencyContent: IndustryContent = {
  ...
  description: "Create stunning travel itineraries and accept bookings from domestic and international tourists.",
  benefits: [
  ...
  whyUs: "Nepal's tourism is booming. Nepdora gives you the tools to compete globally while staying locally relevant with Nepali payment options.",
...
const groceryContent: IndustryContent = {
  ...
  description: "Bring your local grocery shop online and deliver daily essentials to your neighborhood.",
  benefits: [
  ...
  whyUs: "Grocery is all about convenience. Nepdora makes it easy for your customers to order their daily needs in just a few clicks.",
