...
const contentItems: ContentItem[] = [
  {
    name: "Blogs",
    href: "/admin/content-management/blogs",
    icon: Globe,
    description: "Manage blog posts and articles",
  },
  {
    name: "YouTube Videos",
    href: "/admin/content-management/youtube",
    icon: Youtube,
    description: "Manage video content",
  },
  {
    name: "Portfolios",
    href: "/admin/content-management/portfolio",
    icon: Briefcase,
    description: "Manage portfolio projects",
  },
  {
    name: "Popup",
    href: "/admin/content-management/popup",
    icon: Package,
  ...
  {
    name: "Testimonials",
    href: "/admin/content-management/testimonials",
    icon: Tag,
    description: "Manage client testimonials",
  },
  {
    name: "Team",
    href: "/admin/content-management/team",
    icon: Users,
