...
export const metadata: Metadata = {
  ...
  description: "Want to create a website in Nepal? Nepdora makes it easy. From choosing a template to connecting eSewa, learn how to build your site in minutes.",
  keywords: ["create website nepal", "how to build website in nepal", "website creation nepal", "nepal website maker"],
};
  ...
  return (
    <main>
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="mb-12 text-center text-3xl font-bold md:text-5xl">How to Create Your Website in Nepal</h2>
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="p-6 rounded-2xl border border-slate-100 bg-white shadow-sm">
                ...
                <p className="text-slate-600">Select whether you need an e-commerce store, a restaurant menu, or a portfolio site.</p>
            </div>
            <div className="p-6 rounded-2xl border border-slate-100 bg-white shadow-sm">
                <div className="mb-4 text-3xl font-bold text-primary">02</div>
                <h3 className="mb-3 text-xl font-bold">Customize</h3>
                <p className="text-slate-600">Drag and drop sections, add your products, and tell your business story.</p>
            </div>
            <div className="p-6 rounded-2xl border border-slate-100 bg-white shadow-sm">
                <div className="mb-4 text-3xl font-bold text-primary">03</div>
                <h3 className="mb-3 text-xl font-bold">Connect Payments</h3>
                <p className="text-slate-600">Add eSewa, Khalti, or Bank Transfer to start selling across Nepal.</p>
            </div>
            <div className="p-6 rounded-2xl border border-slate-100 bg-white shadow-sm">
                <div className="mb-4 text-3xl font-bold text-primary">04</div>
                <h3 className="mb-3 text-xl font-bold">Go Live</h3>
                <p className="text-slate-600">Hit publish and share your new professional website with the world.</p>
            </div>
        </div>
      </div>
      <FeaturesSection />
