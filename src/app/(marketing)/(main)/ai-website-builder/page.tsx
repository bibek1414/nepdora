...
export const metadata: Metadata = {
  ...
  keywords: ["ai website builder nepal", "artificial intelligence website builder", "auto build website nepal"],
};
...
export default function AIWebsiteBuilder() {
  const schema = {
    ...
    "description": "The first AI-powered website builder for Nepal. Tell us your business name and we build the rest.",
  ...
  return (
    <main>
      ...
      <div className="container mx-auto px-4 py-16 text-center">
        <h2 className="mb-6 text-3xl font-bold md:text-5xl">The Future of Website Building in Nepal</h2>
        <p className="mx-auto max-w-3xl text-lg text-slate-600">
            Forget complex editors. Simply describe your business, and our AI will generate a custom layout, 
            write localized content for Nepal, and optimize your images automatically.
        </p>
      </div>
      <FeaturesSection />
      <CTASection />
