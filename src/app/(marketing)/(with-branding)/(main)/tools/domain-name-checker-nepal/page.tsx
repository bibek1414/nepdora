...
export default function DomainCheckerPage() {
  const schema = {
    ...
    description: "Instantly check domain name availability for .com, .com.np and more in Nepal.",
  ...
  return (
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <section className="relative overflow-hidden pt-20 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="bg-blue-500/5 pointer-events-none absolute bottom-0 left-0 h-[400px] w-[800px] -translate-x-1/2 rounded-full blur-[120px]" />

        <div className="relative container mx-auto max-w-6xl px-4 text-center">
          <div className="mx-auto mb-16 max-w-4xl">
            <div className="mx-auto inline-flex items-center gap-2 px-3 py-1 rounded-full border border-slate-200 bg-slate-50 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-8">
              Local Registry Specialist
            </div>
            <h1 className="mb-8 text-5xl font-black tracking-tighter text-slate-900 md:text-7xl lg:text-8xl leading-[0.9]">
              Find the perfect <br />
              <span className="text-primary italic">domain name.</span>
            </h1>
            <p className="text-lg leading-relaxed text-slate-500 md:text-xl font-medium max-w-2xl mx-auto">
              I scan 500+ registries instantly to find the best .com, .com.np, or 
              specialty extensions for your next big project.
            </p>
          </div>

          <Suspense
            fallback={
              <div className="mx-auto max-w-4xl h-[400px] w-full animate-pulse rounded-[3rem] bg-slate-100" />
            }
          >
      ...
      {/* Guide Section */}
      <section id="np-guide" className="border-t border-slate-100 bg-white py-24">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="mt-8 text-slate-600">
              Registration of <strong>.com.np</strong> domains is completely free for any person or business registered in Nepal. 
              This service is provided by Mercantile Communications and is a great way to establish a local presence.
            </p>
            ...
            <div className="mt-12 rounded-2xl bg-primary/5 p-8 text-center ring-1 ring-primary/10">
              <h3 className="mt-0 text-xl font-bold text-primary">Need Help?</h3>
              <p className="mb-0 text-slate-600">
                Registering a .com.np domain can be tricky. Nepdora provides free assistance for all our hosting customers 
                to get their .com.np domain approved and connected in hours.
              </p>
            </div>
          </div>
        </div>
