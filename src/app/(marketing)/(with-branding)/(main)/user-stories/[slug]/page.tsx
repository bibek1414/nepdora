...
const STORIES = [
  {
    ...
    description: "Brainstorm Global Education, a leading education consultancy, has seen a 3x increase in reservations since launching their Nepdora website.",
    fullStory: [
    ...
    features: ["Online Booking System", "Course Directory", "Student Portal", "Automated Email Alerts"],
  ...
  },
  {
    ...
    description: "xInfin Consultants leveraged Nepdora to build a professional online presence that showcases their expertise.",
    fullStory: [
    ...
    features: ["Service Catalog", "Client Inquiry Forms", "Knowledge Hub", "Professional Branding"],
  ...
  },
  {
    ...
    description: "Bato Ma Tours upgraded their booking experience with a Nepdora-powered website, doubling their revenue.",
    fullStory: [
    ...
    features: ["Vehicle Fleet Management", "Mobile-first Experience", "Real-time Availability", "Route Maps"],
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto max-w-5xl px-6 pt-12">
        ...
        <Link href="/showcase" className="text-primary mt-8 inline-flex items-center gap-2 text-sm font-semibold">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="bg-primary shadow-primary/20 inline-block rounded-2xl p-6 text-white shadow-xl">
                ...
                <div className="text-sm font-medium opacity-80 uppercase tracking-widest">Performance Boost</div>
              </div>
            </div>

            <div className="relative aspect-square overflow-hidden rounded-[3rem] bg-slate-100 shadow-2xl">
              <img src={story.image} alt={story.company} className="h-full w-full object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-slate-100 py-24">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-8 text-2xl font-bold text-slate-900">The Challenge & Solution</h2>
            ...
            <h2 className="mt-16 mb-8 text-2xl font-bold text-slate-900">Key Features Used</h2>
            ...
            <div className="mt-20 rounded-3xl bg-slate-900 p-8 text-white text-center">
              <h3 className="mb-4 text-xl font-bold">Experience {story.company} live</h3>
              <p className="mb-8 text-slate-400">See the real website built on the Nepdora platform.</p>
              <Link href={story.website} target="_blank" className="bg-primary inline-flex items-center gap-2 rounded-full px-8 py-3 font-bold transition-transform hover:scale-105">
