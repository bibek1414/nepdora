...
export default async function ShopifyComparisonPage() {
  ...
  const comparisonSchema = {
    ...
    mainEntity: {
      "@type": "Table",
      about:
        "Cost comparison between Nepdora and Global Builders (Shopify/Wix) for Nepali market",
    },
  };
      ...
      <section className="relative overflow-hidden bg-slate-900 py-20 text-white">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight md:text-6xl">
            ...
            <span className="text-blue-400">Shopify & Wix</span>
          </h1>
          <p className="mx-auto max-w-2xl text-xl text-slate-400">
            Stop paying $500+ annually for global platforms. Get a better,
            localized experience for a fraction of the cost.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-slate-600">
              Based on current USD exchange rates and platform requirements.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
            ...
            {comparisonData.map((row, index) => (
              ...
              >
                <div className="px-6 font-medium text-slate-700">
                  {row.feature}
                </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8 transition-all hover:shadow-lg">
              ...
              <p className="text-slate-600">
                Global platforms require an international credit card for
                subscriptions and themes. Nepdora accepts eSewa, Khalti, and
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8 transition-all hover:shadow-lg">
              ...
              <p className="text-slate-600">
                Integrating eSewa or Khalti on global builders is complex and
                requires third-party scripts. On Nepdora, it's built-in with one
                click.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8 transition-all hover:shadow-lg">
              ...
              <p className="text-slate-600">
                We provide VAT invoices and are a registered Nepalese company,
                making your business accounting simple and legal.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h2 className="mb-8 text-3xl font-bold md:text-5xl">
              Save Over NPR 50,000 Annually
            </h2>
            <p className="mb-10 text-xl text-slate-400">
              By switching from global builders to Nepdora, the average boutique
              store in Nepal saves enough to cover their hosting and marketing
              for a full year.
            </p>
        ...
        <div className="container mx-auto max-w-3xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <p className="text-slate-600">
                Yes, you can easily point your existing .com or .com.np domain
                to Nepdora servers.
              </p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <p className="text-slate-600">
                We offer free migration support for businesses switching from
                Shopify or Wix. We'll help move your products and layout.
              </p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              <h4 className="mb-2 font-bold text-slate-900">
