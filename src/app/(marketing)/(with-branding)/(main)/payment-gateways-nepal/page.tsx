        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="mb-6 text-4xl font-extrabold tracking-tight text-slate-900 md:text-6xl">
              Start Accepting{" "}
              <span className="text-blue-600">Online Payments</span> in Nepal
            </h1>
            <p className="text-xl text-slate-600">
              Stop losing sales because you don't have an international credit
              card. Accept local payments from 20M+ Nepalese users.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-8">
              <h2 className="mb-8 text-3xl font-bold">
                The State of Online Payments in Nepal (2024)
              </h2>
              <div className="prose prose-blue max-w-none text-slate-600">
                <p className="mb-6">
                  For years, starting an e-commerce business in Nepal was
                  difficult due to the lack of seamless payment integration.
                  Most global builders are designed for Stripe or PayPal-which
                  are not natively available in Nepal.
                </p>
                <div className="my-10 rounded-2xl border-l-4 border-blue-600 bg-blue-50 p-8">
                  ...
                  <p className="text-blue-800">
                    Over 80% of online shoppers in Nepal prefer digital wallets
                    like eSewa and Khalti over cash on delivery or international
                    cards.
                  </p>
                </div>

                <h3 className="mt-12 mb-4 text-2xl font-bold text-slate-900">
                ...
                <div className="mt-8 space-y-6">
                  {gateways.map((gw, i) => (
                    <div
                      key={i}
                      className="flex gap-6 rounded-2xl border border-slate-100 p-6 shadow-sm transition-all hover:border-blue-200"
                    >
                      <div
                        className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl font-bold text-white ${gw.color}`}
                      >
                        {gw.name[0]}
                      </div>
                      <div>
                ...
                <h3 className="mt-16 mb-4 text-2xl font-bold text-slate-900">
                  How Nepdora Simplifies This
                </h3>
                <p>
                  Integrating these gateways manually requires advanced coding
                  and a merchant account. With Nepdora, we provide pre-built
                  integrations. You just need to enter your merchant ID, and
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-24 rounded-3xl bg-slate-900 p-8 text-white">
                ...
                <p className="mb-8 text-slate-400">
                  Build your online store with Nepdora and get native eSewa &
                  Khalti integration from day one.
                </p>
                <Link
                  href="/pricing"
                ...
                <div className="mt-10 flex items-center gap-4 text-sm text-slate-400">
                  <span className="flex items-center gap-1">
                    <Zap className="h-4 w-4 text-yellow-400" /> Zero Coding
                  </span>
                  <span className="flex items-center gap-1">
                    <Shield className="h-4 w-4 text-green-400" /> Secure
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-white p-8 text-left">
                ...
                <p className="text-slate-600">
                  Global builders don't support Nepali Rupees or local wallets.
                  You're forced to use sub-optimal payment methods or expensive
                  third-party integrations that slow down your site.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-8 text-left">
                <h4 className="mb-4 flex items-center gap-2 font-bold text-green-600">
                  <Check className="h-5 w-5" /> The Nepdora Advantage
                </h4>
                <p className="text-slate-600">
                  We are built for the local ecosystem. Your customers pay in
                  NPR, via the apps they already have on their phones, with 100%
                  success rates.
                </p>
              </div>
            </div>
